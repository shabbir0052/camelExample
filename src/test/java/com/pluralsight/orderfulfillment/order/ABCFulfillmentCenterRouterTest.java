 ...
 *
 */
@org.junit.runner.RunWith(org.apache.camel.test.spring.CamelSpringRunner.class)
         ...
         return new RouteBuilder() {
            ...
            public void configure() throws Exception {
               ...
               from("activemq:queue:ABC_FULFILLMENT_REQUEST")
                     ...
                     .bean("aBCFulfillmentProcessor", "processAggregate")
                     .marshal()
                     .csv()
                     .to("file://D:/temp/dev/abcfulfillmentcenter/out?fileName=abcfc-"
                           + dateString + ".csv")
